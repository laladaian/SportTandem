	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				</a> <a class="brand" href="#">Sport Tandem</a>
				<div class="nav-collapse collapse">
					<p class="navbar-text pull-right">
						Logged in as
						<s:property value="userBean.username" />
						&nbsp; <a href="<s:url action='logout'/>" class="navbar-link">Log
							out</a>
					</p>
					<ul class="nav">
		...
		<div class="row-fluid">
			<div class="span3">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="#makeFriend">Make a friend</a></li>
			...
			<div class="span7">
				...
				<div class="page-header">
					<h3>You already made request, please check friends tab</h3>
				</div>
				</section>
			</div>
